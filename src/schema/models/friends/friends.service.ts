...
export class FriendsService {
  ...
  public async find(
    options?: FindManyOptions<FriendEntity> | FindManyOptionsFunc<FriendEntity>
  ...
  public async findOne(
    options: FindOneOptions<FriendEntity> | FindOneOptionsFunc<FriendEntity>
  ): Promise<FriendEntity | undefined> {
    const alias = 'friends';
    const op = typeof options === 'function' ? options(alias) : options;
  ...
  public async create(
    options: DeepPartial<FriendEntity>
  ): Promise<FriendEntity> {
