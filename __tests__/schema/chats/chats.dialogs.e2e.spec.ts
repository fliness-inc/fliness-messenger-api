  ...
  describe('[Dialogs] ...', () => {
    ...
    beforeAll(async () => {
      ...
      for (let i = 0; i < 3; ++i) {
        ...
        const { body } = await GraphQLTestRequest.graphql({
          app,
          query: `
    ...
    describe('[Creating] ...', () => {
      it('should create the chat', async () => {
        ...
        const { status, body } = await GraphQLTestRequest.graphql({
          app,
          headers: {
      ...
      it('should return 400 when the creator tries to create a dialog that has already been created', async () => {
        ...
        const {} = await GraphQLTestRequest.graphql({
          app,
          headers: {
            Authorization: `Bearer ${creator.tokens.accessToken}`
          },
    ...
    describe('[Deleting] ...', () => {
      it('should delete the chat', async () => {
        ...
        } = await GraphQLTestRequest.graphql({
          app,
          headers: {
            Authorization: `Bearer ${creator.tokens.accessToken}`
          },
        ...
        const { status } = await GraphQLTestRequest.graphql({
          app,
          headers: {
            Authorization: `Bearer ${creator.tokens.accessToken}`
          },
